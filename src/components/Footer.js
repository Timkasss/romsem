               ...
               <div className="footer__min_container">
                  ...
                  <div className="footer_feedback">
                     ...
                     <input type="tel"
                        ...
                        onClick={maksNumber}
                     />
                     <h3 className="footer_pick_messenger_title">
                        Pick a comfortable <br></br>messenger for conversation
                     </h3>
                     <div className="footer_list_messenger">
                        <a className="messenger_link" href="#">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="none">
                              <g clipPath="url(#clip0_7_1315)">
                                 ...
                                 <path d="M21.6023 16.3351L20.4691 16.2733C20.1132 16.2539 19.7641 16.3728 19.4951 16.6065C18.9457 17.0835 18.0674 18.0058 17.7976 19.2076C17.3953 20.9995 18.017 23.1938 19.6262 25.3881C21.2354 27.5824 24.2342 31.0932 29.537 32.5927C31.2458 33.0759 32.59 32.7501 33.6271 32.0867C34.4485 31.5613 35.0148 30.7179 35.2188 29.7645L35.3998 28.9195C35.4572 28.6509 35.3209 28.3784 35.0714 28.2634L31.2418 26.4982C30.9932 26.3836 30.6984 26.4561 30.5312 26.6727L29.0278 28.6217C28.9142 28.7689 28.7198 28.8273 28.5443 28.7656C27.5147 28.4038 24.066 26.9594 22.1736 23.3143C22.0916 23.1562 22.112 22.9643 22.2284 22.8295L23.6652 21.1673C23.812 20.9976 23.8491 20.7589 23.7609 20.5527L22.1101 16.6906C22.0222 16.485 21.8253 16.3472 21.6023 16.3351Z" fill="white" />
                                 <rect width="51" height="50" rx="25" fill="white" fillOpacity="0.85" />
                              </g>
                              <defs>
                        ...
                        <a className="messenger_link" href="#">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="none">
                              <g clipPath="url(#clip0_77_147)">
                                 <path d="M-0.216677 0.0267644C-4.76142 4.74649 -3.83126 9.76014 -3.83126 24.9914C-3.83126 37.64 -6.03857 50.3199 5.51365 53.3049C9.121 54.2325 41.0836 54.2325 44.6861 53.3001C49.4959 52.0593 53.4093 48.1588 53.9443 41.3575C54.019 40.4082 54.019 9.59149 53.9419 8.62297C53.3732 1.37835 48.9128 -2.79688 43.0354 -3.64252C41.6884 -3.83767 41.4185 -3.8955 34.5074 -3.90754C9.99332 -3.8955 4.61964 -4.98689 -0.216677 0.0267644Z" fill="url(#paint0_linear_77_147)" />
                                 <rect width="51" height="50" rx="25" fill="white" fillOpacity="0.85" />
                              ...
                              <defs>
                                 <linearGradient id="paint0_linear_77_147" x1="-0.105782" y1="50.2213" x2="53.6352" y2="3.70001" gradientUnits="userSpaceOnUse">
                  ...
                  <address className="footer_address">
                     <a className="footer_address_phone" href="tel: +380 67 188 95 55" >Tel: +380 67 188 95 55</a>
                     <a className="footer_address_phone" href="tel: +380 67 188 95 22">Tel: +380 67 188 95 22</a>
                     <a className="footer_address_address" href="https://www.google.com/search?q=64+HILLSIDE+AVE&sca_esv=582658876&sxsrf=AM9HkKnciZntZZFWJqEjRwfECLYXBmx3Uw%3A1700064306499&ei=MuxUZfiCHqqSxc8P3cuh4Ak&ved=0ahUKEwj449WIscaCAxUqSfEDHd1lCJwQ4dUDCBA&uact=5&oq=64+HILLSIDE+AVE&gs_lp=Egxnd3Mtd2l6LXNlcnAiDzY0IEhJTExTSURFIEFWRTIIEAAYywEYgAQyCBAAGMsBGIAEMggQABjLARiABDIIEAAYywEYgAQyCBAAGMsBGIAEMggQABjLARiABDIIEAAYywEYgAQyBhAAGBYYHjIGEAAYFhgeMgYQABgWGB5IqgNQAFgAcAB4AJABAJgBY6ABY6oBATG4AQPIAQD4AQL4AQHiAwQYACBBiAYB&sclient=gws-wiz-serp" target="_blank" >Address: 64 HILLSIDE AVE</a>
                  </address>
               </div>
            </div>
         </div>
